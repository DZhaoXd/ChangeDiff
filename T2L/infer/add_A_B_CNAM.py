...
def modify_percentages(random_string, N=8, class_name=[]):
...
#### class_define
class_name = ['surface', 'ground', 'low vegetation', 'Water', 'Other']
...
source_num = 1500
add_num = 4
save_path = "./sample_results/add_class_CNAM/"
# 创建目标文件夹
if not os.path.exists(save_path):
    os.makedirs(save_path)

## source json
source_base_path = 'train/data/CD_CNAM/train'
source_txt_json_path = 'train/data/CD_CNAM/train/metadata.jsonl'
...
## prompt json
prompt_json_path = 'train/data/CD_CNAM/train/metadata.jsonl'
    ...
    for add_id in range(add_num):
        try:
            if add_id == 0:
                ...
                prompt, ratio_state = modify_percentages(A_prompt, N=3, class_name=class_name)

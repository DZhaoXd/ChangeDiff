...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument("--json_file",
                        type=str,
                        required=True,
                        help="Path to json files with training and Testing images pair")
...
if __name__ == "__main__":
    ...
    try:
        ...
        if opt.actual_resume:
            print(f"Running on model:{opt.actual_resume}")
            # raise None
        ...
        # data
        config.data.params.train.params.json_file = opt.json_file
        config.data.params.validation.params.json_file = opt.json_file

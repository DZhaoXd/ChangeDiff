...
class SSCDL(nn.Module):
    def __init__(self, bc_token_length=1, sc_token_length=7, input_size=512):
        ...
        # 二分类
        # pre_path = '/data2/ywj/SCD/SCanNet_backbone_weights.pth'
        # pre_path = '/data2/ywj/SCD/SCanNet_backbone_weights_GF_9.pth'
        # pre_path = '/data2/yjy/PretrainModel/resnet34_a1_0-46f8f793.pth'
        # pre_path = '/data2/yjy/PretrainModel/resnet50_a1_0-14fe96d1.pth'
        # pre_path = '/data2/yjy/PretrainModel/resnet101_a1h-36d3f2aa.pth'

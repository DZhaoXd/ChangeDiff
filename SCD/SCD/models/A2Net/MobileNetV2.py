...
def mobilenet_v2(pretrained=True, progress=True, **kwargs):
    ...
    if pretrained:
        ...
        state_dict = torch.load('/data/yrz/pretrained/mobilenet_v2-b0353104.pth')
        # state_dict = torch.load('/data2/ywj/SCD/A2Net_backbone_weights.pth') 二分类
        #A2Net_backbone_weights_GF_9.pth 多分类
        # state_dict = torch.load('/data2/ywj/SCD/A2Net_backbone_weights_GF_9.pth')

...
def split_train_test(root, dir_pair=None, train_size=1.0, random_seed=42, save_path=None, prefix=None, flag=None, save=False,SyntheticID=False):
    ...
    if dir_pair is None:
        ...
        for dir_name in dir_pair:
            ...
            if SyntheticID:
                file_pair_list.append(sorted(file_list1))
...
if __name__ == '__main__':
    ...
    # root = '/data2/yjy/FreeStyleNet/outputs/guofeng_9class'
    sub_dir = ['image', 'label' ]
    prefix = None
    flag = None
    train_size = 1
    save_path = '/data2/ywj/SCD/json/SECOND/FreeStyleNet_Syn_SECOND_Image1.json'
    ...
    root = '/data/yrz/data/SECOND/train'
    # sub_dir = ['A', 'B', 'label', 'label' ]
    sub_dir = ['im1','im2','label1','label2']
    prefix = None
    flag = None
    train_size = 1
    save_path = '/data2/ywj/SCD/json/SECOND/train_ori_SECOND_Image1.json'
    ret2 = split_train_test(root, sub_dir, train_size=train_size, prefix=prefix, flag=flag, save_path=save_path, save=True)
    # #
    save_path = '/data2/ywj/SCD/json/SECOND/FreeStyleNet_Syn_SECOND_add_100_ori.json'
